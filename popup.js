...
function getImageKeywords(img) {
  ...
  //       'tTaX1--dlyFIHWf78q23767aui0zhVRcG2X-bBWY',
  //       'jbozimU9L8NT5NEBU9tK_gukvPabSWjkfV3c0FvM'
  // );
  var app = new Clarifai.App(
        apiKey.value,
        apiSecret.value
...
function reset() {
  ...
  // thing.
  storage.remove('apiValues', function(items) {
    message('Reset stored API keys');
  });
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.apiSecret = document.getElementById('apiSecret');
  ...
  goButton.addEventListener('click', getCurrentTabUrl(getImageKeywords));
});